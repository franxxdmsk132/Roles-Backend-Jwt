...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                .authorizeRequests()
                .antMatchers("/auth/**").permitAll() // Permitir acceso a los endpoints de autenticación
                .antMatchers("/admin/**").hasRole("ADMIN") // Permitir solo a ADMIN
                .antMatchers("/empl/**").hasRole("EMPL") // Permitir solo a EMPLEADO
